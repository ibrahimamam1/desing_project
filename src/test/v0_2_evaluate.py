...
def _get_env_class(version):
    if version == "heuristic_continous":
        from envs.alpha_env_v02 import AlphaEnv_v01
        return AlphaEnv_v01
    elif version == "heuristic_discrete":
        from envs.alpha_env_v02_discrete import AlphaEnv_v01_Discrete
        return AlphaEnv_v01_Discrete
    elif version == "attention_continous":
        from envs.alpha_env_v02_attention_continous import AlphaEnv_v01_Attention
        return AlphaEnv_v01_Attention
    elif version == "attention_discrete":
        from envs.alpha_env_v02_attention_discrete import AlphaEnv_v01_AttentionDiscrete
        return AlphaEnv_v01_AttentionDiscrete
    elif version == "heuristic_attention_continous":
        from envs.alpha_env_v02_heuristic_attention_continous import AlphaEnv_v01_HeuristicAttention
        return AlphaEnv_v01_HeuristicAttention
    elif version == "heuristic_attention_discrete":
        from envs.alpha_env_v02_heuristic_attention_discrete import AlphaEnv_v01_HeuristicAttentionDiscrete
...
def main():
    ...
    try:
        plot_eval_results(
            ...
            save_path=os.path.join(output_dir, f"{version}_v02.png"),
            show=False,
        )

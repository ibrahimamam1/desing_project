...
def _get_env_class(version):
    if version == "heuristic_continous":
        from envs.alpha_env_v04 import AlphaEnv_v01
        return AlphaEnv_v01
    elif version == "heuristic_discrete":
        from envs.alpha_env_v04_discrete import AlphaEnv_v01_Discrete
        return AlphaEnv_v01_Discrete
    elif version == "attention_continous":
        from envs.alpha_env_v04_attention_continous import AlphaEnv_v01_Attention
        return AlphaEnv_v01_Attention
    elif version == "attention_discrete":
        from envs.alpha_env_v04_attention_discrete import AlphaEnv_v01_AttentionDiscrete

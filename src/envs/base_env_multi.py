...
class Env_Multi(MultiAgentEnv, metaclass=ABCMeta):
    """
    Multi-Agent Environment for Autonomous Intersection Management.
    """
    ...
    def step(self, action_dict):
        ...
        # 4. Check Global Terminations/Truncations
    ...
    def reset(self, *, seed=None, options=None):
        """
        Reset the environment, returning multi-agent dictionaries.
        """
        self._init_telemetry()
        ...
        # Fast-forward simulation until at least one RL agent spawns
        ...
        self._agent_ids = set(self.k.vehicle.get_rl_ids())
        self.agents_spawned = len(self._agent_ids)
        
        # Construct observation dict for newly spawned agents
        obs_dict = {
            agent_id: self.get_state(agent_id) 
    ...
    def _apply_rl_actions(self, rl_actions_dict):
        """
        Takes a dict mapping agent_id -> action. 
        Must loop through dict and apply actions to respective vehicles.
        """
        pass
    ...
    def get_state(self, agent_id):
        """
        Must return the observation specific to 'agent_id'.
        """
        pass
    
    def get_dummy_state(self):
        """
        Returns a zero-filled array matching the observation space shape.
        Used when an agent has exited the network but RLlib requires a final observation.
        """
    ...
    def compute_reward(self, agent_id, fail, goal_reached, **kwargs):
        """
        Computes the reward specific to 'agent_id'.
        """
        pass
